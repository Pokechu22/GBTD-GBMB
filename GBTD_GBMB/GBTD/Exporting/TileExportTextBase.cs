	...
	public abstract class TileExportTextBase : ITileExporter
	{
		...
		protected void WriteHeader(GBRObjectTileExport settings, GBRObjectTileData tileData, String fileName) {
			...
			Stream.WriteLine(HeaderLine + "  Form                 : " + 
				(settings.StoreTilesInArray ? "All tiles as one unit." : "Each tile seperate."));
			Stream.WriteLine(HeaderLine + "  Format               : "); //TODO
			Stream.WriteLine(HeaderLine + "  Compression          : "); //TODO
			Stream.WriteLine(HeaderLine + "  Counter              : "); //TODO
			...
			Stream.WriteLine(HeaderLine + "  SGB Palette          : "); //TODO
			Stream.WriteLine(HeaderLine + "  CGB Palette          : "); //TODO
			Stream.WriteLine(HeaderLine);
			...
			if (settings.MakeMetaTiles) {
				...
				Stream.WriteLine(HeaderLine + "  Index counter      : "); //TODO
			}
			Stream.WriteLine(HeaderLine);
