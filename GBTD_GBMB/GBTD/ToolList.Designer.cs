namespace GB.GBTD
{
	partial class ToolList
	{
		...
		private void InitializeComponent() {
			...
			this.button4 = new GB.GBTD.ToolList.ToolListButton();
			this.button3 = new GB.GBTD.ToolList.ToolListButton();
			this.button2 = new GB.GBTD.ToolList.ToolListButton();
			this.button1 = new GB.GBTD.ToolList.ToolListButton();
		...
		private ToolList.ToolListButton button4;
		private ToolList.ToolListButton button3;
		private ToolList.ToolListButton button2;
		private ToolList.ToolListButton button1;
