namespace GB.GBTD.Dialogs
{
	partial class ImportDialog
	{
		...
		private void InitializeComponent() {
			...
			this.labelFirstGBTDTile.Format = stringFormat8;
			...
			this.labelTileCount.Format = stringFormat9;
			...
			this.labelFirstByteToUse.Format = stringFormat11;
			...
			this.labelFormat.Format = stringFormat12;
			...
			this.firstGBTDTileTextBox.Value = ((uint)(0u));
			// 
			// tileCountTextBox
			// 
			...
			this.firstImportFileTileTextBox.Value = ((uint)(0u));
			// 
			...
			this.firstByteToUseTextBox.Value = ((uint)(0u));
			// 
			// formatComboBox
			// 
			...
			this.labelFileName.Format = stringFormat14;
			...
			this.labelType.Format = stringFormat13;
