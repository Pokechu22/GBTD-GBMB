namespace GB.GBTD.Dialogs
{
	partial class ExportDialog
	{
		...
		private void InitializeComponent() {
			...
			this.labelSection.Format = stringFormat15;
			...
			this.labelBank.Format = stringFormat16;
			...
			this.labelFrom.Format = stringFormat17;
			...
			this.labelTo.Format = stringFormat18;
			...
			this.labelFormat.Format = stringFormat19;
			...
			this.labelCounter.Format = stringFormat20;
			...
			this.labelFileName.Format = stringFormat21;
			...
			this.labelType.Format = stringFormat22;
